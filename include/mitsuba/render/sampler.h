 ...
 *   3. \c advance can be used to advance to the next sample in the sequence. When
 *      multiple samples per pixel are rendered in parallel in the wavefront, the appropriate
 *      sample index offset will be applied to ensure we do not compute the same sample twice.
