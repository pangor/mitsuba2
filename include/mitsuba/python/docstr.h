...
static const char *__doc_OptixParams_in_maxt = R"doc()doc";
...
static const char *__doc_mitsuba_Sampler_m_wavefront_sample_offsets = R"doc(Array of offsets to compute current sample index in wavefront modes)doc";
